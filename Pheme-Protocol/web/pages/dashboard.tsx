    ...
    if (isMobile) {
      ...
      return (
        <div className="fixed inset-0 z-50 bg-background-light dark:bg-background-dark flex flex-col overflow-hidden">
          {/* Backdrop blur for everything except chat */}
          <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-[-1]" aria-hidden="true" />
          
          {/* Disconnect button at the top */}
          <div className="px-4 py-3 flex justify-end border-b border-gray-200 dark:border-gray-800 flex-shrink-0 bg-white dark:bg-gray-900 relative z-10">
            <button
              onClick={() => {
                disconnect();
              }}
