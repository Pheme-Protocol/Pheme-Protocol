      ...
      <div className="min-h-screen flex flex-col bg-gradient-to-b from-amber-50 via-white to-blue-50 dark:from-background-dark dark:to-background-dark text-gray-900 dark:text-white transition-colors relative overflow-hidden" lang="en">
        ...
        <header className={`container mx-auto px-4 sm:px-6 py-4 sm:py-6 flex justify-between items-center relative z-10 ${
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-r from-blue-600 to-blue-800 dark:from-blue-400 dark:to-blue-600 bg-clip-text text-transparent">PHEME</h1>
          </div>
          <Navigation />
        </header>
        ...
        <main id="main-content" className="flex-grow relative z-10">
          <div className="container mx-auto px-4 sm:px-6 py-4 sm:py-6 md:py-12">
            ...
            {/* Features section */}
            {(!isMobile || !isConnected) && (
              <div className="mt-12 sm:mt-20 lg:mt-32 -mx-4 px-4">
                {/* Headline above features */}
                <div className="my-8 sm:my-12 lg:my-16 text-center">
                  <h2 className="text-base sm:text-lg md:text-xl lg:text-2xl font-semibold bg-gradient-to-r from-blue-600 to-blue-800 dark:from-blue-400 dark:to-blue-600 bg-clip-text text-transparent max-w-3xl mx-auto px-4">
