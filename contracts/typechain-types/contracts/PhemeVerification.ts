...
export interface PhemeVerificationInterface extends Interface {
  ...
  getEvent(
    nameOrSignatureOrTopic: "OwnershipTransferred" | "VerificationCreated"
  ): EventFragment;

  encodeFunctionData(
    functionFragment: "createVerification",
    values: [string]
  ): string;
...
export namespace VerificationCreatedEvent {
  ...
  export type OutputTuple = [user: string, skillId: string, timestamp: bigint];
  export interface OutputObject {
    user: string;
    skillId: string;
    timestamp: bigint;
...
export interface PhemeVerification extends BaseContract {
  ...
  createVerification: TypedContractMethod<
    [skillId: string],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "createVerification"
  ): TypedContractMethod<[skillId: string], [void], "nonpayable">;
  getFunction(
  ...
  filters: {
    ...
    "VerificationCreated(address,string,uint256)": TypedContractEvent<
      VerificationCreatedEvent.InputTuple,
      VerificationCreatedEvent.OutputTuple,
      VerificationCreatedEvent.OutputObject
    >;
