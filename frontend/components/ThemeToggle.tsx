...
export function ThemeToggle() {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-r from-amber-400/20 to-indigo-600/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
      {theme === 'dark' ? (
